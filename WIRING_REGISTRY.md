...
| consumer-drain | engines.egocentric.consumer:consume | cognitive_loop.py:594 | LIVE | 2026-08-16 | W1 once-per-episode budgeted drain (budget_n=8); 2026-08-17: PHASE 2 now takes its agenda from the RANKED drain (drain-ranked row) instead of pending() FIFO |
